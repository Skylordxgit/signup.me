...
export function SignupForm({ invitationToken, invitedEmail = '' }: { invitationToken?: string; invitedEmail?: string }) {
  ...
  return (
    <>
      <h1>{invitationToken !== undefined ? 'Join workspace' : 'Create account'}</h1>
      <form className="authEmailForm" onSubmit={submit}>
        ...
        <input name="email" type="email" defaultValue={invitedEmail} readOnly={invitationToken !== undefined} maxLength={190} placeholder="you@example.com" autoComplete="email" required />
