...
notification campaigns. They cannot view the team list, create accounts, reset
other passwords, or enable/disable accounts. Team API routes enforce Owner access.
